...
| Second core | ✅ | — |
| Task pinning | ⛔ [#20](https://github.com/cooljackal/flintos/issues/20) | — |
| DMA | ⛔ | ⛔ |
...
| | |
|---|---|
| Host unit tests | ✅ 349 passing, kernel included |
...
tools/check-devices.sh `make device-matrix` — who keeps which device promise
