...
FlintOS runs the scheduler on both — see [Multicore](/developers/multicore/).
...
| APP CPU | ✅ | Second core started, cache enabled, joined to the scheduler. Runs tasks like the first. See [Multicore](/developers/multicore/). |
