...
See [Architecture](/developers/architecture/) for how `lib/` sits against the driver layers,
and [Writing a Driver](/developers/writing-a-driver/) for implementing a contract.
