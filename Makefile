...
HOST_EXCLUDE   := arch-xtensa hello demo blink imu pwm smp spidma flashprobe radioprobe wifiscan wificonnect
...
XTENSA_BOARD_FEATURES = --features board/$(XTENSA_BOARD),kernel/$(XTENSA_BOARD),demo/$(XTENSA_BOARD),hello/$(XTENSA_BOARD),smp/$(XTENSA_BOARD),spidma/$(XTENSA_BOARD),flashprobe/$(XTENSA_BOARD),radioprobe/$(XTENSA_BOARD),wifiscan/$(XTENSA_BOARD),wificonnect/$(XTENSA_BOARD)
